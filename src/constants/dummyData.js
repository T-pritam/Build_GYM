...
export const gymActivities = [
  {
    ...
    emoji: '🏸',
    color: '#FF6B00',
    description: 'Play a quick singles or doubles match on our indoor badminton court. Rackets available at reception.',
    duration: '60 min',
    difficulty: 'All levels',
    maxParticipants: 4,
    coinsPerSession: 150,
    slots: ['6:00 AM', '7:00 AM', '5:00 PM', '6:00 PM', '7:00 PM'],
    available: true,
    tag: 'Popular',
  },
  {
    ...
    emoji: '🧘',
    color: '#9C27B0',
    description: 'Group yoga session led by certified instructor. Covers flexibility, balance, breathing and mindfulness.',
    duration: '45 min',
    difficulty: 'Beginner friendly',
    maxParticipants: 12,
    coinsPerSession: 100,
    slots: ['6:30 AM', '8:00 AM', '6:30 PM'],
    available: true,
    tag: 'Trending',
  },
  {
    ...
    emoji: '🏓',
    color: '#2196F3',
    description: 'Singles or doubles TT match on our professional-grade table. Paddles and balls provided.',
    duration: '30 min',
    difficulty: 'All levels',
    maxParticipants: 4,
    coinsPerSession: 80,
    slots: ['7:00 AM', '12:00 PM', '4:00 PM', '6:00 PM', '8:00 PM'],
    available: true,
    tag: null,
  },
  {
    ...
    emoji: '🔥',
    color: '#F44336',
    description: 'High-intensity interval training circuit with trainer guidance. Burns up to 500 calories in one session.',
    duration: '45 min',
    difficulty: 'Intermediate',
    maxParticipants: 8,
    coinsPerSession: 120,
    slots: ['6:00 AM', '7:00 AM', '5:30 PM', '6:30 PM'],
    available: true,
    tag: 'Hot',
  },
  {
    ...
    emoji: '🏀',
    color: '#FF9800',
    description: 'Book the half-court for a pickup game with friends. Perfect for a quick competitive match.',
    duration: '60 min',
    difficulty: 'All levels',
    maxParticipants: 6,
    coinsPerSession: 200,
    slots: ['7:00 AM', '5:00 PM', '6:00 PM', '7:00 PM'],
    available: true,
    tag: null,
  },
  {
    ...
    emoji: '💃',
    color: '#E91E63',
    description: 'High-energy dance fitness class. Fun, upbeat and a great full-body cardio workout.',
    duration: '50 min',
    difficulty: 'Beginner friendly',
    maxParticipants: 15,
    coinsPerSession: 100,
    slots: ['8:00 AM', '5:00 PM', '7:00 PM'],
    available: true,
    tag: 'New',
  },
  {
    ...
    emoji: '♟️',
    color: '#607D8B',
    description: 'Strategic board game in our relaxation lounge. Challenge a friend or request an opponent from reception.',
    duration: '60 min',
    difficulty: 'All levels',
    maxParticipants: 2,
    coinsPerSession: 50,
    slots: ['Any time during gym hours'],
    available: true,
    tag: null,
  },
  {
    ...
    emoji: '🌿',
    color: '#4CAF50',
    description: 'Guided meditation session in our dedicated calm room. Helps with stress, focus and recovery.',
    duration: '30 min',
    difficulty: 'All levels',
    maxParticipants: 10,
    coinsPerSession: 60,
    slots: ['6:00 AM', '1:00 PM', '7:00 PM'],
    available: true,
    tag: null,
  },
];
